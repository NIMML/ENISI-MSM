...
if "%INCLUDE%"=="" call  "%ProgramFiles(x86)%\Microsoft Visual Studio 14.0\VC\bin\vcvars32.bat" %1
...
SET TEMP_DIR=tmp_vs14_x86_%BUILD_TYPE%
SET BIN_DIR=bin_vs14_x86_%BUILD_TYPE%
