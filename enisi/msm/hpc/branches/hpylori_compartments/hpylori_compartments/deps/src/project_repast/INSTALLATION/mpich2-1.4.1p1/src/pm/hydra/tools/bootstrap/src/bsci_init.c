...
static const char *rmk_array[] = {  "user",  "slurm",  "ll",  "lsf",  "sge",  "pbs",  NULL };
...
static HYD_status(*rmk_init_array[])(void) = {  HYDT_bsci_rmk_user_init,  HYDT_bsci_rmk_slurm_init,  HYDT_bsci_rmk_ll_init,  HYDT_bsci_rmk_lsf_init,  HYDT_bsci_rmk_sge_init,  HYDT_bsci_rmk_pbs_init,  NULL };
/* *INDENT-ON* */
