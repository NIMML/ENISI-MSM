...
if("${BUILD_STEP}" STREQUAL "build")
  ...
  execute_process(
    COMMAND ./build_visit --no-thirdparty --console --no-visit --szip --hdf5 --silo
...
#if("${BUILD_STEP}" STREQUAL "get_visit_platform")
  #message(WARNING "DEBUG GETTING VISIT PLATFORM")
  #execute_process(
    #COMMAND bash ./scripts/get_visit_platform.sh "${VISIT_DIR}"
    #WORKING_DIRECTORY ${PROJECT_SOURCE_DIR}
    #OUTPUT_VARIABLE PLATFORM
    #)
  #message(WARNING "DEBUG PLATFORM " ${PLATFORM})
#endif()
